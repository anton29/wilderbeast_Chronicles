...
init -1 python hide:
    ...
    config.window_title = u"wilderbeast Chronicles"

    # These control the name and version of the game, that are reported
    # with tracebacks and other debugging logs.
    config.name = "wilderbeast Chronicles"
    config.version = "0.0"
...
python early:
    config.save_directory = "wilderbeast Chronicles-1462989023"
...
init python:
    ...
    build.directory_name = "wilderbeast_Chronicles-1.0"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "wilderbeast_Chronicles"
